...
update ui_report set report = '<template>
  ...
  <details>
    ...
    <datagrid name="items" databind="items" border="1" border-color="218" font-size="10" header-background="245">
      <columns>
        <column width="4%" fieldname="counter" align="right" label="labels.lb_no" header-align="center"/>
        ...
        <column width="9%" fieldname="vatamount" align="right" thousands=" " digit="2" label="labels.lb_vat_value" header-align="right"/>
    ...
    <datagrid width="50%" name="taxgroup" databind="taxgroup" border="1" border-color="218" font-size="10" header-background="245">
      <columns>
        ...
        <column width="27%" fieldname="vatamount" align="right" thousands=" " digit="2" label="labels.lb_vat_value" footer="head.0.sum_vatamount" footer-align="right" header-align="right"/>
    ...
    <vgap height="4"/>
    <row>
      <cell name="label" value="azaz "  align="right" />
      <cell width="0" name="label" align="left" font-style="bold" value="={{isumamount}} forint"/>
    </row>
    <row>
